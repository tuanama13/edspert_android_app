...
ExerciseResponse exerciseResponseFromJson(String str) => ExerciseResponse.fromJson(json.decode(str));

String exerciseResponseToJson(ExerciseResponse data) => json.encode(data.toJson());
